...
Shipping Harness v1.0.0 is an internal-only control plane. A component is reported as supported only after its exact combination passes the local compatibility checks; discovery of a binary alone is not proof of readiness.
...
| MCP | `2026-07-28`; legacy `2025-11-25` | Unsupported protocol versions fail clearly |
