...
const FUNCTION_LENGTH_ALLOWLIST = [
  ...
  { file: 'src/core/plain-brief.mjs', startLine: 221, reason: 'buildBriefFactGraph constructs one bounded fact-graph object with many literal fields required by the plain-brief schema' },
