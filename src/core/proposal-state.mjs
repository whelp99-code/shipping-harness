...
export function proposalSummary(proposal) {
  ...
  return {
    ...
    briefFactGraph: proposal.briefFactGraph ?? null,
    actionEnvelope: proposal.actionEnvelope ?? null,
    plainBrief: proposal.plainBrief ?? null,
    plainBriefText: proposal.plainBriefText ?? null,
    plainBriefError: proposal.plainBriefError ?? null,
